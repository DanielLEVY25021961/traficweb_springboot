...
public interface IProfilController {
	...
	/**
	 * <b>crée un objet métier avec les valeurs de la VUE 
	 * pDTO dans le stockage 
	 * et retourne l'objet METIER persisté</b>.<br/>
	 * <ul>
	 * <li>ne crée <b>pas de doublon</b>.</li>
	 * <li>retourne null si l'objet métier correspondant à 
	 * pDTO existe déjà dans le stockage.</li>
	 * </ul>
	 * - retourne null si pDTO == null.<br/>
	 * <br/>
	 *
	 * @param pDTO : ProfilDTO : 
	 * le DTO (VUE) de l'objet métier à persister dans le stockage.<br/>
	 * 
	 * @return IProfil : 
	 * l'objet métier persisté dans le stockage (avec ID).<br/>
	 * 
	 * @throws Exception
	 */
	IProfil create(ProfilDTO pDTO) throws Exception;
	 ...
	 * index (0-based) de l'objet métier à modifier.<br/>
	 * 
	 * @return boolan : true si l'objet est détruit.<br/>
	 * 
	 * @throws Exception
	 */
