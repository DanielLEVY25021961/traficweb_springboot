...
public class InternauteTest {
	 ...
	 * "Halliday".<br/>
	 */
	public static final String HALLIDAY = "Halliday";
	
	/**
	 * "12345".<br/>
	 */
	public static final String PASS12345 = "12345";
	
	/**
	 * "zorro.halliday".<br/>
	 */
	public static final String ZORRO_HALLIDAY = "zorro.halliday";
	
	/**
	 * "Papy".<br/>
	 */
	public static final String PAPY = "Papy";
	 ...
	 * .<br/>
	 */
	public static List<IProfil> listeProfilsAdminSeul;
	
	/**
	 * .<br/>
	 */
	public static List<IProfil> listeProfilsComplexe;
	
	
	/**
	 * .<br/>
	 */
	public static List<IProfil> listeProfilExploitants;
	
	
	/**
	 * .<br/>
	 */
	public static List<IProfil> listeProfilsConsultants;
	
	/**
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IInternaute objet1 
		= new Internaute(1L, ZORRO, HALLIDAY, ZORRO_HALLIDAY, PASS12345, listeProfilsAdminSeul);
	...
	public static transient IInternaute objet2EqualsObj1 
		= new Internaute(2L, PAPY, GONZALEZ, ZORRO_HALLIDAY, PASS12345, listeProfilsComplexe);
	
	/**
	 * objet1, objet2EqualsObj1, objet3EqualsObj1 doivent être equals().
	 */
	public static transient IInternaute objet3EqualsObj1 
		= new Internaute(3L, PAPY, GONZALEZ, ZORRO_HALLIDAY, PASS12345, listeProfilsComplexe);
	...
	public static transient IInternaute objet1AvecNull 
		= new Internaute(11L, PAPY, GONZALEZ, ZORRO_HALLIDAY, null, listeProfilsComplexe);
	...
	public static transient IInternaute objet2EqualsObjet1AvecNull 
		= new Internaute(12L, PAPY, GONZALEZ, ZORRO_HALLIDAY, null, listeProfilsComplexe);
	
	/**
	 * objetDiff1 doit être différent de objetDiff2
	 */
	public static transient IInternaute objetDiff1 
		= new Internaute(1L, "Stanislas", "de la Perrière", "aaa@free.fr", "aaaa", listeProfilsConsultants);
	
	/**
	 * objetDiff2 doit être différent de objetDiff1
	 */
	public static transient IInternaute objetDiff2 
		= new Internaute(2L, "Cunégonde", "de la Perrière", "bbb@free.fr", "bbb", listeProfilsConsultants);
	...
	public static transient IInternaute objetDiff1AvecNull 
		= new Internaute(1L, "Stanislas2", "de la Perrière2", null, "aaaa", listeProfilsConsultants);
	...
	public static transient IInternaute objetDiff2AvecNull 
		= new Internaute(2L, "Cunégonde2", "de la Perrière2", "bbb@free.fr", null, listeProfilsConsultants);
	
	/**
	 * objetCompAvant doit être AVANT objetCompApres.
	 */
	public static transient IInternaute objetCompAvant 
		= new Internaute(1L, "Stanislas3", "de la Perrière3", "aaa@free.fr", "aaaa", listeProfilExploitants);
	
	/**
	 * objetCompApres doit être APRES objetCompAvant.
	 */
	public static transient IInternaute objetCompApres 
		= new Internaute(2L, "Cunégonde3", "de la Perrière3", "bbb@free.fr", "bbb", listeProfilExploitants);
	...
	public void testEquals() {
		...
		System.out.println("********** CLASSE InternauteTest - méthode testEquals() ********** ");
		}
	...
	public void testCompareTo() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
		System.out.println("********** CLASSE InternauteTest - méthode testCompareTo() ********** ");
		}
	...
	public void testClone() throws CloneNotSupportedException {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE InternauteTest - méthode testClone() ********** ");
		}
	...
	public void testToString() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE InternauteTest - méthode testToString() ********** ");
		}
	...
	public void testgetEnTeteCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE InternauteTest - méthode testgetEnTeteCsv() ********** ");
		}
	...
	public void testToStringCsv() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE InternauteTest - méthode testToStringCsv() ********** ");
		}
	...
	public void testGetEnTeteColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE InternauteTest - méthode testGetEnTeteColonne() ********** ");
		}
	...
	public void testGetValeurColonne() {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE InternauteTest - méthode testGetValeurColonne() ********** ");
		}
    ...
    public static void avantTests() throws CloneNotSupportedException {
		...
		listeProfilsAdminSeul = new ArrayList<IProfil>();
		listeProfilsComplexe = new ArrayList<IProfil>();
		listeProfilExploitants = new ArrayList<IProfil>();
		listeProfilsConsultants = new ArrayList<IProfil>();
		
		listeProfilsAdminSeul.add(profilAdmin);
		
		listeProfilsComplexe.add(profilAdmin);
		listeProfilsComplexe.add(profilExploitantDIRA);
		listeProfilsComplexe.add(profilConsultant1);
		listeProfilsComplexe.add(profilCharge1);
		listeProfilsComplexe.add(profilCharge2);
		listeProfilsComplexe.add(profilExploitantDIRO);
		
		listeProfilExploitants.add(profilExploitantDIRA);
		listeProfilExploitants.add(profilExploitantDIRO);
		
		listeProfilsConsultants.add(profilConsultant1);
		
		objet1.setProfils(listeProfilsAdminSeul);
		objet2EqualsObj1.setProfils(listeProfilsComplexe);
		objet3EqualsObj1.setProfils(listeProfilsComplexe);
		objetDiff1.setProfils(listeProfilsConsultants);
		objetDiff2.setProfils(listeProfilsConsultants);
		objetDiff1AvecNull.setProfils(listeProfilsConsultants);
		objetDiff2AvecNull.setProfils(listeProfilsConsultants);
		objetCompAvant.setProfils(listeProfilExploitants);
		objetCompApres.setProfils(listeProfilExploitants);
